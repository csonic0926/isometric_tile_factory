# Gameplay Factory ownership

This department owns reusable gameplay methods, validators, schemas and CLI
compatibility. Filled game artifacts belong only in the target game repository.
For current operation use the `gameplay-factory` skill.
...
- Capability rules: `gameplay/docs/WORKFLOW_V2.md`.
- v1 compatibility/detail: `gameplay/docs/WORKFLOW_V1.md`. Its semantic
